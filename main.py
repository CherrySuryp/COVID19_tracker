...
def statMenu(message):
    ...
    # Меню рекомендаций
        ...
        bot.send_message(message.chat.id,
                         ...
                         'Получайте новые знание, учитесь зарабатывать онлайн, осваивайте новые профессии\n\n'
                         'Мир уже точно не будет преждним и оффлайн рабта потеряет свою актуальность\n\n'
